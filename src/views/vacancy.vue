            ...
            <div class="sidebar-inner" style="position: relative; transform: translate3d(0px, 0px, 0px);">
              ...
              <div class="vl-block">
                  ...
                  <div class="vl-block__check jsCheckBlock" v-show="categoriesShow">
                    ...
                    <label class="checkbox" v-for="(item, index) in categories" :key="index">
              ...
              <div class="vl-block">
                  ...
                  <div class="vl-block__check jsCheckBlock" v-show="employmentTypeShow">
                    ...
                    <label class="checkbox" v-for="(item, index) in employmentType" :key=" index">
                      <input type="checkbox" name="employmentType"
                             :value="item.value"
              ...
              <div class="vl-block no-border">
                  ...
                  <div class="vl-block__inputs jsCheckBlock" v-show="paymentShow">
                    <input type="text" name="min_salary" value="" v-model="formData.minSalary">
                    <input type="text" name="max_salary" value="" v-model="formData.maxSalary">
                  </div>
                </div>
    ...
    components: {
     ...
     data() {
      return {
        ...
        categories: [
          {id: 0, value: 'IT, компьютеры, интернет '},
          {id: 1, value: 'Администрация, руководство'},
          {id: 2, value: 'Бухгалтерия, аудит'}
        ],
        employmentType: [
          {id: 1, value: 'Удаленная работа'},
