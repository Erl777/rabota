...
<style>
  ...
  /*}*/
    ...
    @font-face {
        font-family: 'Muller';
        src: url("assets/fonts/muller/MullerExtraBold.otf");
        font-weight: 800;
        font-style: normal;
        font-display: swap; }
    ...
    @font-face {
        font-family: 'Muller';
        src: url("assets/fonts/muller/MullerBold.otf");
        font-weight: 700;
        font-style: normal;
        font-display: swap; }
    ...
    @font-face {
        font-family: 'Muller';
        src: url("assets/fonts/muller/MullerMedium.otf");
        font-weight: 500;
        font-style: normal;
        font-display: swap; }
    ...
    @font-face {
        font-family: 'Muller';
        src: url("assets/fonts/muller/MullerRegular.otf");
        font-weight: 400;
        font-style: normal;
        font-display: swap; }
    ...
    @font-face {
        font-family: 'Muller';
        src: url("assets/fonts/muller/MullerLight.otf");
        font-weight: 300;
        font-style: normal;
        font-display: swap; }
...
.mobile-nav-btn span {
    ...
    margin: 2px 0;
    background: #000000; }
.mobile-nav-btn.activeBtn {
    -webkit-transition: all ease .3s;
    -o-transition: all ease .3s;
    transition: all ease .3s; }
.mobile-nav-btn.activeBtn span:first-child {
    position: absolute;
    margin: 0;
    -webkit-transform: rotate(45deg);
    -ms-transform: rotate(45deg);
    transform: rotate(45deg); }
.mobile-nav-btn.activeBtn span:nth-child(2) {
    display: none; }
.mobile-nav-btn.activeBtn span:last-child {
    position: absolute;
    margin: 0;
    -webkit-transform: rotate(-45deg);
    -ms-transform: rotate(-45deg);
